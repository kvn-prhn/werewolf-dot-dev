...
var app = (function () {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, server64 });
    ...
    class Discord extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { server64: 0 });
    		...
    		if (/*server64*/ ctx[0] === undefined && !("server64" in props)) {
    			console.warn("<Discord> was created without expected prop 'server64'");
    		}
    	}

    	get server64() {
    		throw new Error("<Discord>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set server64(value) {
    		throw new Error("<Discord>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    class DirectionSign extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { index: 4 });
    ...
    function create_each_block(ctx) {
    	let li;
    	let raw_value = /*listItem*/ ctx[9] + "";

    	const block = {
    		c: function create() {
    			li = element("li");
    			attr_dev(li, "class", "svelte-5gh3nz");
    			add_location(li, file$2, 59, 10, 1310);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			span1 = element("span");
    			attr_dev(span0, "class", "intro svelte-5gh3nz");
    			add_location(span0, file$2, 55, 4, 1188);
    			attr_dev(ol, "class", "svelte-5gh3nz");
    			add_location(ol, file$2, 57, 6, 1260);
    			attr_dev(div, "class", "list svelte-5gh3nz");
    			add_location(div, file$2, 56, 4, 1234);
    			attr_dev(span1, "class", "outro");
    			add_location(span1, file$2, 63, 4, 1383);
    			attr_dev(section, "class", "sign-text svelte-5gh3nz");
    			add_location(section, file$2, 54, 2, 1155);
    			attr_dev(main, "class", "wooden-sign-component svelte-5gh3nz");
    			attr_dev(main, "style", /*style*/ ctx[1]);
    			toggle_class(main, "active", /*active*/ ctx[0]);
    			add_location(main, file$2, 53, 0, 1094);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { selectedIndex } = getContext("sign-select");
    	validate_store(selectedIndex, "selectedIndex");
    	component_subscribe($$self, selectedIndex, value => $$invalidate(7, $selectedIndex = value));
    	const writable_props = ["index"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("outro" in $$props) $$invalidate(3, outro = $$props.outro);
    		if ("list" in $$props) $$invalidate(4, list = $$props.list);
    		if ("marginTop" in $$props) $$invalidate(8, marginTop = $$props.marginTop);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*index, $selectedIndex*/ 192) {
    			 $$invalidate(0, active = index === $selectedIndex);
    		}
    	};

    	 $$invalidate(1, style = `margin-top: ${marginTop}`);
    	return [active, style, intro, outro, list, selectedIndex, index, $selectedIndex];
    }

    class WoodenSign extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { index: 6 });
...
`
    ...
    class Server64 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { server64: 0 });
    ...
    // (13:1) <Route path="/:server64" let:params>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:1) <Route path=\\\"/:server64\\\" let:params>",
    		ctx
    	});
    ...
    // (17:1) <Route path="/:server64/discord" let:params>
    function create_default_slot_1(ctx) {
    	let discord;
    	let current;
    	const discord_spread_levels = [/*params*/ ctx[0]];
    	let discord_props = {};

    	for (let i = 0; i < discord_spread_levels.length; i += 1) {
    		discord_props = assign(discord_props, discord_spread_levels[i]);
    	}

    	discord = new Discord({ props: discord_props, $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(discord, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const discord_changes = (dirty & /*params*/ 1)
    			? get_spread_update(discord_spread_levels, [get_spread_object(/*params*/ ctx[0])])
    			: {};

    			discord.$set(discord_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    		...
    		d: function destroy(detaching) {
    			destroy_component(discord, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:1) <Route path=\\\"/:server64/discord\\\" let:params>",
    		ctx
    	});
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Discord, Home, Server64 });
    	return [];
    }
